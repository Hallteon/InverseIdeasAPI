...
urlpatterns = [
    ...
    path('api/proposals/requirements/generate/', ProposalAPIGenerateFuncionalRequirementsView.as_view(), name='proposals_generate_requirements'),
    ...
    path('api/proposals/posts/search/', ProposalPostAPIListSearchView.as_view(), name='proposal_posts_search'),
